...
export default function signin() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const response = await fetch("http://localhost:5000/api/loginrider", {
      method: "POST",
      headers: {
    ...
    if (json.success) {
      console.log("FULL LOGIN RESPONSE:", json);
  ...
  <div className="d-flex align-items-center justify-content-center vh-100 bg-light">
    <div className="card shadow-lg p-4 border-0" style={{ width: "100%", maxWidth: "400px" }}>
      ...
      <div className="text-center mb-4">
        <h2 className="fw-bold text-success">🍔 Welcome Back Rider</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="text-center">
          ...
          <Link to="/createrider" className="fw-bold text-danger text-decoration-none">
            Sign up
          </Link>
        </div>
      </form>
